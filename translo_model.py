...
import time
import numpy as np
from conv_util import PointNetSaModule, cost_volume, set_upconv_module, FlowPredictor, Conv1d, Conv2d, All2AllCostVolume
...
class translo_model(nn.Module):
    def __init__(self, args, batch_size, H_input, W_input, is_training, bn_decay=None):
        ...
        # Cost volume #
        #############################
        self.allcost1 = All2AllCostVolume(radius=None, nsample=4, nsample_q=16, in_channels=64, mlp1=[128, 64, 64],
    ...
    def forward(self, input_xyz_f1, input_xyz_f2, T_gt, T_trans, T_trans_inv):
        ...
        # l3_points_cross_f1, l3_points_cross_f2 = self.cross_trans3(l3_points_f1, l3_points_f2, l3_mask_f1, l3_mask_f2)
        # l3_points_cross_proj_f1 = torch.reshape(l3_points_cross_f1,
        #                                         (batch_size, self.out_H_list[3], self.out_W_list[3], -1))
        # l3_points_cross_proj_f2 = torch.reshape(l3_points_cross_f2,
        #                                         (batch_size, self.out_H_list[3], self.out_W_list[3], -1))
        #
        # l2_cost_volume_origin = self.cost_volume1(l2_xyz_proj_f1, l2_xyz_proj_f2, l2_points_proj_f1,
        #                                           l2_points_proj_f2)
        # l2_cost_volume_origin_proj = torch.reshape(l2_cost_volume_origin,
        #                                            [batch_size, self.out_H_list[2], self.out_W_list[2], -1])  ##E2
        # l3_cost_volume, l3_cost_volume_proj = self.laye3_1(l2_xyz_proj_f1, l2_cost_volume_origin_proj,
        #                                                    l3_xyz_proj_f1)  ##E3
        ...
        l2_cost_volume_origin = self.allcost1(l2_xyz_f1, l2_points_cross_f1, l2_xyz_f2, l2_points_cross_f2)
        ...
        l3_cost_volume = self.merging3(l2_cost_volume_origin)  ##E3
